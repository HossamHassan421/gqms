<form method="post" action="{{ route('users.store') }}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label>Type</label>
                <select name="type" id="type" class="select2" data-placeholder="Choose ..." tabindex="-1"
                        aria-hidden="true" required>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select name="roles[]" id="roles_create" class="select2 select2-multiple" multiple=""
                        data-placeholder="Choose ..." tabindex="-1" aria-hidden="true" required>
                    @foreach($roles as $role)
                        @if($role->uuid != 'ee7945a5-59d8-4a4e-9457-c698639f7797')
