                                            ...
                                            <table class="table">
                                                <tr>
                                                    <td class="text-center">
                                                        <span
                                                            class="number-app">{{ ($queue = \App\RoomQueue::getCurrentRoomQueues($room->id)) ? $queue->queue_number : '-' }}</span>
                                                    </td>
                                                    <td class="text-right">
                                            ...
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td class="col-md-8 text-right">
                                                        <span id="doctor-{{ $room->uuid }}"
                                                            class="text-app-1">{{ $room->user ? $room->user->doctor->name_ar : '-' }}</span>
                                                        <span id="clinic-{{ $room->uuid }}"
                                                            class="text-app-2">{{ $room->user ? $room->user->doctor->speciality->name_ar : '-' }}</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <div class="txt-3 text-center">
                                            <table class="table">
                                                <tr>
                                                    <td class="text-center">
                                                        <span
                                                            class="number-app">{{ ($queue = \App\DeskQueue::getCurrentDeskQueues($desk->id)) ? $queue->queue_number : '-' }}</span>
                                                    </td>
                                                    <td class="text-right">
                                                        <span class="text-app">حجز</span>
                                                    </td>
